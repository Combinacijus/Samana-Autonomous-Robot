...
;//! \htmlinclude Sonar9.msg.html

(cl:defclass <Sonar9> (roslisp-msg-protocol:ros-message)
  ((Header
    :reader Header
    :initarg :Header
...
(cl:defclass Sonar9 (<Sonar9>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Sonar9>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Sonar9)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name samana_msgs-msg:<Sonar9> is deprecated: use samana_msgs-msg:Sonar9 instead.")))

(cl:ensure-generic-function 'Header-val :lambda-list '(m))
(cl:defmethod Header-val ((m <Sonar9>))
...
(cl:defmethod dist1-val ((m <Sonar9>))
...
(cl:defmethod dist2-val ((m <Sonar9>))
...
(cl:defmethod dist3-val ((m <Sonar9>))
...
(cl:defmethod dist4-val ((m <Sonar9>))
...
(cl:defmethod dist5-val ((m <Sonar9>))
...
(cl:defmethod dist6-val ((m <Sonar9>))
...
(cl:defmethod dist7-val ((m <Sonar9>))
...
(cl:defmethod dist8-val ((m <Sonar9>))
...
(cl:defmethod dist9-val ((m <Sonar9>))
  ...
  (dist9 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Sonar9>) ostream)
  "Serializes a message object of type '<Sonar9>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Sonar9>) istream)
  "Deserializes a message object of type '<Sonar9>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sonar9>)))
  "Returns string type for a message object of type '<Sonar9>"
  "samana_msgs/Sonar9")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sonar9)))
  "Returns string type for a message object of type 'Sonar9"
  "samana_msgs/Sonar9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sonar9>)))
  "Returns md5sum for a message object of type '<Sonar9>"
  "9475c4b12aca5b9b235ea1a9e9e22280")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sonar9)))
  "Returns md5sum for a message object of type 'Sonar9"
  "9475c4b12aca5b9b235ea1a9e9e22280")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sonar9>)))
  "Returns full string definition for message of type '<Sonar9>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sonar9)))
  "Returns full string definition for message of type 'Sonar9"
  (cl:format cl:nil "std_msgs/Header Header~%int16 dist1~%int16 dist2~%int16 dist3~%int16 dist4~%int16 dist5~%int16 dist6~%int16 dist7~%int16 dist8~%int16 dist9~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Sonar9>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Sonar9>))
