...
(cl:defmethod cl:initialize-instance :after ((m <imu_small>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'imu_small)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name samana_msgs-msg:<imu_small> is deprecated: use samana_msgs-msg:imu_small instead.")))
...
(cl:defmethod quaternion_x-val ((m <imu_small>))
...
(cl:defmethod quaternion_y-val ((m <imu_small>))
...
(cl:defmethod quaternion_z-val ((m <imu_small>))
...
(cl:defmethod quaternion_w-val ((m <imu_small>))
...
(cl:defmethod linear_acceleration_x-val ((m <imu_small>))
...
(cl:defmethod linear_acceleration_y-val ((m <imu_small>))
...
(cl:defmethod linear_acceleration_z-val ((m <imu_small>))
...
(cl:defmethod angular_velocity_x-val ((m <imu_small>))
...
(cl:defmethod angular_velocity_y-val ((m <imu_small>))
...
(cl:defmethod angular_velocity_z-val ((m <imu_small>))
