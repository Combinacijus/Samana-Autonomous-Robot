...
(cl:defclass <RCState> (roslisp-msg-protocol:ros-message)
  ((allow_rc
    :reader allow_rc
    :initarg :allow_rc
    :type cl:boolean
...
(cl:defclass RCState (<RCState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RCState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RCState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name samana_msgs-msg:<RCState> is deprecated: use samana_msgs-msg:RCState instead.")))

(cl:ensure-generic-function 'allow_rc-val :lambda-list '(m))
(cl:defmethod allow_rc-val ((m <RCState>))
...
(cl:defmethod armed-val ((m <RCState>))
...
(cl:defmethod auton_mode-val ((m <RCState>))
...
(cl:defmethod arm_mode-val ((m <RCState>))
  ...
  (arm_mode m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RCState>) ostream)
  "Serializes a message object of type '<RCState>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RCState>) istream)
  "Deserializes a message object of type '<RCState>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RCState>)))
  "Returns string type for a message object of type '<RCState>"
  "samana_msgs/RCState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RCState)))
  "Returns string type for a message object of type 'RCState"
  "samana_msgs/RCState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RCState>)))
  "Returns md5sum for a message object of type '<RCState>"
  "f93b20a9c6f7b0344addef9c5a6daf0f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RCState)))
  "Returns md5sum for a message object of type 'RCState"
  "f93b20a9c6f7b0344addef9c5a6daf0f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RCState>)))
  "Returns full string definition for message of type '<RCState>"
  (cl:format cl:nil "bool allow_rc~%bool armed~%bool auton_mode~%uint8 arm_mode~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RCState)))
  "Returns full string definition for message of type 'RCState"
  (cl:format cl:nil "bool allow_rc~%bool armed~%bool auton_mode~%uint8 arm_mode~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RCState>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RCState>))
